...
### Principles:
- Store complex condition results in descriptive variables
- Use early returns or guard clauses for validation
- Prefer positive conditions over negative ones
...
- Keep a blank line between namespace groups
- Use file-scoped namespaces (C# 10+) for conciseness
